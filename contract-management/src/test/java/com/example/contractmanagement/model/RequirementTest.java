...
class RequirementTest {
	...
	void testDeliveryDate() {
		...
		assertEquals(requirement.getDeliveryDate(), DateUtil.convertToDate("01/01/2022"));
	}
	...
	void testToString() {
		...
		type.setType("Type1");
		requirement.setType(type);
		String toString = "Requirements [id=1, description=Some Text, deliveryDate="+(DateUtil.convertToDate("01/01/2022"))+", type=Type1]";
